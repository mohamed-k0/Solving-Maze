...
class MoveYawServer(Node):
    def __init__(self):
        ...
        self.declare_parameter('min_angular_vel', 0.15)
        #integral windup 
    ...
    def execute_callback(self, goal):
        ...
        try:
            ...
            self.yaw_pid.reset()
            self.yaw_pid.set_target(target_yaw)
            ...
            while rclpy.ok():
                ...
                previous_time = now
                angular_velocity = self.yaw_pid.control(self.progress, dt)
                ...
                min_angular_vel = float(self.get_parameter('min_angular_vel').value)
                if abs(angular_velocity) < min_angular_vel:
